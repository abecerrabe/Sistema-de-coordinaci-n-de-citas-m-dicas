...
('Juan Pablo Cuellar Vanegas','jpcuellarva1@gmail.com', '312111331','jPablo1*', 1211223456, 'paciente','activo'),
('Kevin Steven Parra Norena','ksparran1@gmail.com','312222333','k-Ste133', 1294919423,'paciente','activo'),
('Maria Alejandra Nunez Chaucanes','manunezc1@gmail.com','312333444','m_aleja*', 1112445690, 'medico','activo'),
('Carlos Caicedo Perez', 'carlitoscaicedo4@gmail.com','312444555','carPe-12', 1233399255, 'medico','activo'),
('Alejandra Becerra Bellaiza','abecerrabe1@gmail.com','312345678','aleja12*', 1112940289, 'administrador','activo'),
('Javier Arias','jarias3@gmail.com', '319383929', 'jArias3*', 1010239312,'administrador','activo');
